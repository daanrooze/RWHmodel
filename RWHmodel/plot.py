...
class Plot(Model):
    ...
    def plot_meteo(
        ...
        # Export
        fig.savefig(f"{root}/output/figures/{name}_forcing_{plot_name}.png", dpi=300, bbox_inches='tight')
        fig.savefig(f"{root}/output/figures/{name}_forcing_{plot_name}.svg", dpi=300, bbox_inches='tight')
